    ...
    Mix.Project.in_project(:my_app, ".", fn _module ->
      ...
      assert File.read!(@config_path) ==
               ...
               config :my_app, MyAppWeb.Endpoint,
                 url: [host: "localhost"],
                 render_errors: [formats: [html: Beacon.Web.ErrorHTML, json: MyAppWeb.ErrorJSON], layout: false],
               ...
               defmodule MyApp.Application do
                 ...
                 def start(_type, _args) do
                   children = [
                     ...
                     # {MyApp.Worker, arg}
                    {Beacon, sites: [[site: :my_site, repo: MyApp.Repo, endpoint: MyAppWeb.Endpoint, router: MyAppWeb.Router]]}
               ]
