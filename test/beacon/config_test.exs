defmodule Beacon.ConfigTest do
  ...
  describe "template_formats" do
    test "preserve default config" do
      assert %{
             ...
             } = Config.new(site: :site, endpoint: :endpoint, repo: :repo, template_formats: [])
    end
    ...
    test "merge existing config" do
      assert %{
             ...
             } = Config.new(site: :site, endpoint: :endpoint, repo: :repo, template_formats: [{:heex, "Custom HEEx description"}])
    end
    ...
    test "add config" do
      assert %{
             ...
             } = Config.new(site: :site, endpoint: :endpoint, repo: :repo, template_formats: [{:custom_format, "Custom Format"}])
    end
  end
  ...
  describe "lifecycle" do
    test "preserve default config" do
      assert %{
             ...
             } = Config.new(site: :site, endpoint: :endpoint, repo: :repo, lifecycle: [load_template: []])
    end
  end
  ...
  describe "assets" do
    test "sets defaults" do
      assert [
             ...
             ] = Config.new(site: :site, endpoint: :endpoint, repo: :repo).assets
    end
  end
  ...
  describe "config_for_media_type/2" do
    test "retrieves" do
      ...
      config = Config.new(site: :site, endpoint: :endpoint, repo: :repo)
