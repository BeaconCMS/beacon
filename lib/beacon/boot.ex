    ...
    def init(config) do
      boot = fn ->
        ...
        modules = [
          ...
          # TODO: load main pages (order_by: path, per_page: 10) so the home page and other important pages are loaded eagerly which can avoid SEO issues due to slow robot requests
        ]
