defmodule DummyAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DummyAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DummyAppWeb.Gettext, "errors", msg, opts)
    end
  end
